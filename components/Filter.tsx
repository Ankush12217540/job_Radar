...
const Filter = ({ onFilterChange }) => {
  ...
  return (
    <div className="border-2 border-gray-300 rounded-lg shadow-lg bg-white mx-4">
      ...
      <div className="p-6 border-b border-gray-200">
        <h3 className="text-lg font-semibold text-gray-700 mb-4">Job Type</h3>
        <div className="flex items-center gap-x-4 mb-3">
          <input
            type="checkbox"
            id="full-time"
      ...
      <div className="p-6 border-b border-gray-200">
        <h3 className="text-lg font-semibold text-gray-700 mb-4">Job Sector</h3>
        <div className="flex items-center gap-x-4 mb-3">
          <input
            type="checkbox"
            id="government"
            ...
            onChange={handleCheckboxChange}
          />
          <label htmlFor="government" className="text-gray-600">
            Government
          </label>
        </div>
        <div className="flex items-center gap-x-4 mb-3">
